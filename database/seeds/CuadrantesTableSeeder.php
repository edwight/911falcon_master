...
class CuadrantesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        ['cuadrante' => 'P-1',
            ...
            'organismo_id'=>'3',//gnb
            'municipio_id'=>'4',//casique manaure
            'localidad'=>'YARACAL']
            );
        Cuadrante::create(
        ['cuadrante' => 'P-1',
            ...
            'organismo_id'=>'1',//polifalcon
            'municipio_id'=>'16',//casique manaure
            'localidad'=>'K-14']
            );
    }
